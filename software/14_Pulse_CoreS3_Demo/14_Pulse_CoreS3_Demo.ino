...
// =====================================================
//  PulseCore / Pluto 9000 - CoreS3/SE Demo Iteration 14
...
void handleTouch() {
  ...
  if (t.wasPressed()) {
    ...
    if (currentScreen == SCREEN_HOME) {
      if (simpleHome) {
        if (insideRect(x, y, 10, 72, 300, 64)) { running = !running; uiNeedsFullRedraw = true; return; }
